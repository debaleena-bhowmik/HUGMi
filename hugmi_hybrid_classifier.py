...
if __name__ == "__main__":
    ...
    parser.add_argument("--max_accepts", type=int, default=10, help="Maximum number of hits to keep for each query")
    parser.add_argument("--perc_identity", type=float, default=1.0, help="Rejects if percent identity to query is lower")
    parser.add_argument("--query_cov", type=float, default=0.95, help="Rejects if alignment coverage is lower")
    parser.add_argument("--classifier_confidence", type=float, default=0.7, help="Confidence threshold for sklearn")
    parser.add_argument("--num_threads", type=int, default=5, help="Number of threads (CPUs) used for both classifiers")
